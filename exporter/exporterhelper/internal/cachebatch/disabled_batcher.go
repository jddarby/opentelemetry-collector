...
// disabledBatcher is a special-case of Batcher that has no size limit for sending. Any items read from the cache will
...
func (db *disabledBatcher[T]) Consume(ctx context.Context, req T, done cache.Done) {
